...
if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['id_patrulla'])) {
    ...
    // Consulta SQL con INNER JOIN y filtro por tipo = 1
    $query = "
    ...
    WHERE ea.id_patrulla = $idPatrulla AND a.id_actividad = 1 OR a.id_actividad = 31 AND ea.id_patrulla = $idPatrulla
    ";
