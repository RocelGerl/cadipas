...
if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['id_patrulla'])) {
    ...
    $query = "
        SELECT et.*, a.nombre AS nombre_actividad, a.tipo AS actividad_tipo
    FROM evaluacion_talleres et
    JOIN actividades a ON et.id_actividad = a.id_actividad
    WHERE et.id_patrulla = $idPatrulla AND a.id_actividad >=16 AND a.id_actividad!=19 AND a.id_actividad!=20 AND a.id_actividad!=21
    ";
