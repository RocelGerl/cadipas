...
<body>
    ...
    <div class="panel-container">
        ...
        <form action="../controller/subirPuntajeS.php" method="post">
            ...
            <div class="row">
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select text-center" id="formacion" name="formacion" required>
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        <label for="uniformidad" class="form-label">Uniformidad</label>
                        <select class="form-select text-center" id="uniformidad" name="uniformidad" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select text-center" id="limpieza" name="limpieza" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        <label for="sistemaequipos" class="form-label">Sistema de Equipos</label>
                        <select class="form-select text-center" id="sistemaequipos" name="sistemaequipos" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
        ...
        <a href="calificarS.php" class="btn btn-panel btn-secondary">
