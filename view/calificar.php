...
<body>
    ...
    <div class="panel-container">
        <h1><i class="fas fa-qrcode"></i> Lector QR<br>Actividades</h1>

        <!-- Contenedor para la imagen y la cámara -->
        <div class="scanner-wrapper">
            <!-- Imagen de referencia -->
            <img src="../assets/img/qr.jpeg" class="img-fluid" alt="" id="imagenReferencial">
            ...
            if (cameraId) {
                ...
                html5QrCode.start(
                    ...
                    qrCodeMessage => {
                        ...
                        window.location.href = `qrLeido.php?qr=${encodeURIComponent(qrCodeMessage)}`;
                    },
                    errorMessage => {
