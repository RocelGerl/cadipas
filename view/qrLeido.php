...
$query = "SELECT tipo, nombre , id_actividad FROM actividades WHERE encargado = $id_usuario AND tipo != 3 ";
...
<body>
    ...
    <div class="panel-container">
        <h2><i class="fas fa-tents"></i> Registrar Puntaje de Actividades</h2>
        <form action="../controller/subirPuntaje.php" method="post">
            <div class="row pt-2 mb-2" style="border-top: 2px dotted  #00F5FF; border-bottom: 2px dotted  #00F5FF;">
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select text-center" id="actividad" name="actividad" required>
                            ...
                            if (!empty($actividades)) {
                                ...
                                echo "<option value='' disabled>No tiene actividades asignadas</option>";
                            }
                            ?>
                        </select>
                    </div>
            ...
            <div class="row">
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select text-center" id="puesto" name="puesto" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">Primer Lugar</option>
                            <option value="2">Del Segundo Lugar para abajo</option>
                        </select>
                    </div>
                </div>
                <div class="col col-12 col-sm-6 col-lg-6">
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        <label for="reglas" class="form-label">Cumplimiento de Reglas</label>
                        <select class="form-select text-center" id="reglas" name="reglas" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                <div class="col col-12 col-sm-6 col-lg-6">
                    <div class="mb-3">
                        <label for="espiritu" class="form-label">Espiritu Scout</label>
                        <select class="form-select text-center" id="espiritu" name="espiritu" required>
                            <option value="" selected disabled>Selecciona un puntaje</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
        ...
        <a href="calificar.php" class="btn btn-panel btn-secondary">
